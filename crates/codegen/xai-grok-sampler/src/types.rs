...
use xai_grok_sampling_types::{
    ConversationRequest, ResolvedResponsesRequest, ValidatedLegacyReplayV1,
};
...
/// like historical behavior. `ResolvedResponses` and `LegacyV1` carry an
/// opaque, already-validated frozen body: every retry reuses the identical
/// body, correlation headers and continuity metadata (plan-once,
/// body-frozen retry) and the attempt never re-reads shell state.
#[derive(Clone, Debug)]
